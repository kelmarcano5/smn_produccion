package domain.repgen.smn_configuracion.smn_caracteristica_almacen;
...
public class XmlReport extends GenericOutput
{
	...
	public void print(TemplateEngine te, GenericTransaction data) throws Throwable
	{
		...
		String nameCustom  = "b_caracteristicas_almacen";
		String labelCustom = "${lbl:b_caracteristicas_almacen}";
