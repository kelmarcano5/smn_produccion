...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("smn_caracteristica_item_name");
			if (d != null)
			{
			name  = "b_caracteristicas_item";
			label = "${lbl:b_caracteristicas_item}";
		...
		d = rs.getString("smn_caracteristica_item");
			if (d != null)
			{
			name  = "b_caracteristicas_item";
			label = "${lbl:b_caracteristicas_item}";
		...
		d = rs.getString("smn_codigo_impuesto_rf_name");
			if (d != null)
			{
			name  = "b_tax_code";
			label = "${lbl:b_tax_code}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_codigo_impuesto_rf");
			if (d != null)
			{
			name  = "b_tax_code";
			label = "${lbl:b_tax_code}";
